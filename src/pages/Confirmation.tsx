...
import { Check, MapPin, Phone, MessageCircle, Calendar, Clock, Plane, User, Home } from 'lucide-react';
...
const Confirmation = () => {
  ...
  const { selectedAirport, selectedMenu, orderDetails, isOrderComplete, resetOrder } = useOrder();

  useEffect(() => {
    if (!isOrderComplete || !selectedAirport || !selectedMenu) {
      navigate('/');
    }
  }, [isOrderComplete, selectedAirport, selectedMenu, navigate]);
  ...
  if (!selectedAirport || !selectedMenu || !orderDetails) return null;

  const totalPrice = selectedMenu.price * (orderDetails.passengerCount || 1);
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{orderDetails.tailNumber}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {new Date(orderDetails.flightDate || '').toLocaleDateString('en-GB', {
                      weekday: 'long',
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric',
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-sans text-sm text-muted-foreground">Delivery Time</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-sans text-sm text-muted-foreground">Contact</p>
                  <p className="font-medium">{orderDetails.attendantName}</p>
                </div>
              </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {orderDetails.passengerCount} guests × €{selectedMenu.price.toLocaleString()}
                    </p>
                  </div>
